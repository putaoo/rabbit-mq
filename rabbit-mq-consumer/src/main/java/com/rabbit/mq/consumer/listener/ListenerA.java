...
public class ListenerA implements ChannelAwareMessageListener {
    ...
    public void onMessage ( Message message , Channel channel ) throws Exception {
        //logger.info("Listener A 消费消息：{}",new String(message.getBody()));
        //System.out.println(new String(message.getBody()));
        System.out.println("Listener A 消费消息: "+ message.getMessageProperties().getHeaders().get("spring_returned_message_correlation"));
    }
}
